...
const DrawDominancePage: React.FC = () => {
  ...
  const doneDrawing = async () => {
    ...
    // Mark dominance sequence as completed
    sess.completedSequences = sess.completedSequences || {};
    sess.completedSequences.dominance = true;
    ...
    console.log("DOMINANCE COMPLETE = TRUE");
    ...
    } else if (!prestigeCompleted) {
      console.log("Going to prestige sequence");
